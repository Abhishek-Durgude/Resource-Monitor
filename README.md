...
1. **[Download the latest `.deb` package](https://github.com/Abhishek-Durgude/Resource-Monitor/raw/main/resource-dashboard_1.1-2_all.deb)** from this repository.
2. Install it using `apt` (this automatically handles required dependencies):
   ```bash
   sudo apt install ./resource-dashboard_1.1-2_all.deb
   ```
